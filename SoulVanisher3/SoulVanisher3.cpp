...
int main()
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        do {
            row = rand() % 3 + 1;
        } while (row == enemyPositions[0][0] || row 
            == enemyPositions[1][0] || row == enemyPositions[2][0]);
        ...
        if (i == 0) {
           // Personaje   enmyChar1("Malo", 1, 100, 5, 5, 0, enemyPositions[i][0], enemyPositions[i][1], "M", true);
            ...
            cout << enmyChar1.getPosX() << " " << enmyChar1.getPosY() << endl;
            Sleep(1000);
        }
        else if (i == 1) {
            enmyChar2.setPosX(enemyPositions[i][0]);
            enmyChar2.setPosY(enemyPositions[i][1]);
            cout << enmyChar2.getPosX() << " " << enmyChar2.getPosY() << endl;
            Sleep(1000);
            ...
            cout << enmyChar3.getPosX() << " " << enmyChar3.getPosY() << endl;
            Sleep(1000);
